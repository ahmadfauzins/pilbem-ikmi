...
Class Admin_Model extends CI_Model {
	...
	public function datacalon1() {
		$load	= $this->db->query("SELECT * FROM tb_pilihan WHERE no='1'");
		return $load->result_array();
	}
	public function datacalon2() {
		$load	= $this->db->query("SELECT * FROM tb_pilihan WHERE no='2'");
		return $load->result_array();
	}
	public function datacalon3() {
		$load	= $this->db->query("SELECT * FROM tb_pilihan WHERE no='3'");
		return $load->result_array();
	}
